...
[q -> 0.09] [r -> 5.34] [s -> 5.82] [t -> 8.84] [u -> 2.82] [v -> 0.88] [w -> 2.46] 
[x -> 0.12] [y -> 2.04] [z -> 0.03] 
Benchmark time: 1.7590000000000001 secs
==resources/test.txt==
Char count: 1031
Word count: 268
Dict size: 147
...
[n -> 6.28] [o -> 9.27] [p -> 2.34] [q -> 0.11] [r -> 4.79] [s -> 6.07] [t -> 8.41] 
[u -> 3.62] [v -> 0.11] [w -> 1.81] [x -> 0.11] [y -> 2.98] 
==resources/test_malville_moby.txt==
Char count: 955386
Word count: 219048
Dict size: 18618
Most used words (>1 percent): [a, and, his, in, it, of, that, the, to]
'love' count: 24
'hate' count: 9
'music' count: 4
vowels (percentage): 37.43
a:e count ratio: 0.65
[A -> 0.24] [B -> 0.14] [C -> 0.12] [D -> 0.06] [E -> 0.07] [F -> 0.07] [G -> 0.05] 
[H -> 0.13] [I -> 0.33] [J -> 0.03] [K -> 0.01] [L -> 0.07] [M -> 0.07] [N -> 0.08] 
[O -> 0.06] [P -> 0.12] [Q -> 0.03] [R -> 0.07] [S -> 0.20] [T -> 0.24] [U -> 0.01] 
[V -> 0.01] [W -> 0.13] [X -> 0.00] [Y -> 0.02] [Z -> 0.00] [a -> 7.95] [b -> 1.63] 
[c -> 2.26] [d -> 3.95] [e ->12.23] [f -> 2.11] [g -> 2.13] [h -> 6.49] [i -> 6.54] 
[j -> 0.09] [k -> 0.83] [l -> 4.42] [m -> 2.38] [n -> 6.80] [o -> 7.21] [p -> 1.71] 
[q -> 0.13] [r -> 5.42] [s -> 6.55] [t -> 9.01] [u -> 2.79] [v -> 0.89] [w -> 2.20] 
[x -> 0.11] [y -> 1.74] [z -> 0.06] 
Benchmark time: 2.037 secs
==resources/test.txt==
Char count: 1031
Word count: 268
Dict size: 147
